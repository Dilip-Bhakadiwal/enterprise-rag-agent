...
export const DatasetCardsSection: React.FC<DatasetCardsSectionProps> = ({ onOpenRag }) => {
  ...
  const datasets: DatasetCardData[] = [
    {
      id: "medical-dataset",
      themeColor: "from-[#0f172a]/90 via-[#0e7490]/70 to-[#020617]", // Cyan / Teal clinical glass
      accentTextColor: "text-cyan-400",
      title: "Clinical Oncology & Medical Intelligence",
      metric1Label: "Clinical Corpus",
      metric1Value: "44 Volumes",
      metric2Label: "Evidence Facts",
      metric2Value: "3,106 Triples",
      coverageLabel: "Coverage",
      coverageItem1: "NCCN Guidelines",
      coverageItem2: "BCC & CSCC",
      highlights: [
        "Basal cell & squamous cell carcinoma diagnostics",
        "Adrenal tumors and Mohs surgical guidelines",
        "Deterministic clinical fact-checking via Neo4j",
      ],
      sampleQuery: "What are the primary risk factors and clinical diagnostic guidelines for Basal Cell Carcinoma?",
    },
    {
      id: "literature-dataset",
      themeColor: "from-[#1e1b4b]/80 via-[#581c87]/70 to-[#020617]", // Deep Violet / Purple glass
      accentTextColor: "text-purple-400",
      title: "Multi-Hop Literature Knowledge Graph",
      metric1Label: "Classic Works",
      metric1Value: "20 Books",
      metric2Label: "Entity Triples",
      metric2Value: "4,368 Triples",
      coverageLabel: "Global Scope",
      coverageItem1: "GraphRAG-Bench",
      coverageItem2: "Multi-Hop QA",
      highlights: [
        "Complex character & historical place relations",
        "Multi-hop cross-corpus relationship reasoning",
        "Context-preserving narrative retrieval",
      ],
      sampleQuery: "Within the account of St. Michael's Mount, who married Princess Frederica of Hanover?",
    },
    {
      id: "research-dataset",
